...
?>
<TITLE>产品服务--<?php echo $rowImgFenlei['fenleiname_ziduan']?></TITLE>
...
$Page_size=20; 
$result=mysql_query("select * from hyimg_table where fenlei_ziduan='$fenleiId'"); 
...
$sql="select * from hyimg_table where fenlei_ziduan='$fenleiId' limit $offset,$Page_size"; 
