...
<div class="contentRightTop">招贤纳士</div>
<?php

$queryZhaopin="select * from hyzhaopin_table";
$resultZhaopin=mysql_query($queryZhaopin);
$rowZhaopin = mysql_fetch_array($resultZhaopin);

?>
<div class="zhaopinContent"><?php  echo $rowZhaopin["zhaopin_ziduan"];?></div>
</div>
</div>
...
mysql_free_result($resultZhaopin); 
mysql_close(); 
?>
</BODY>
</HTML>
