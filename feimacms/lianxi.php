...
$queryXinxi="select * from hyxinxi_table";
$resultXinxi=mysql_query($queryXinxi);
$rowXinxi = mysql_fetch_array($resultXinxi);

?>
<div class="contentRight">
<div class="contentRightTop">联系方式</div>
<div class="lxContent">
<div class="lxText">
<div class="lxTextLeft">企业名称：</div>
<div class="lxTextRight"><?php  echo $rowXinxi["name_ziduan"];?></div>
</div>
<div class="lxText">
<div class="lxTextLeft">联系人：</div>
<div class="lxTextRight"><?php  echo $rowXinxi["lxr_ziduan"];?></div>
</div>
<div class="lxText">
<div class="lxTextLeft">QQ：</div>
<div class="lxTextRight"><?php  echo $rowXinxi["qq_ziduan"];?></div>
</div>
<div class="lxText">
<div class="lxTextLeft">电话：</div>
<div class="lxTextRight"><?php  echo $rowXinxi["tel_ziduan"];?></div>
</div>
<div class="lxText">
<div class="lxTextLeft">传真：</div>
<div class="lxTextRight"><?php  echo $rowXinxi["fax_ziduan"];?></div>
</div>
<div class="lxText">
<div class="lxTextLeft">手机：</div>
<div class="lxTextRight"><?php  echo $rowXinxi["shouji_ziduan"];?></div>
</div>
<div class="lxText">
<div class="lxTextLeft">Email：</div>
<div class="lxTextRight"><?php  echo $rowXinxi["email_ziduan"];?></div>
</div>
<div class="lxText">
<div class="lxTextLeft">联系地址：</div>
<div class="lxTextRight"><?php  echo $rowXinxi["dizhi_ziduan"];?></div>
</div>
</div>
</div>
