...
<form enctype="multipart/form-data" method="post" action="include/top.php"> 
<div class="topTupian">
<div class="topTupianTop">Top图片设置</div>
<div class="topTupianLeft">图片地址：</div><div class="topTupianRight">
<input type="file" size="40" name="upfile">
<input type="hidden" name="MAX_FILE_SIZE" value="2000000">
</div>
<div class="tupianSize">TOP图片大小：1000px * 120px</div>
</div>
<div class="topTupianBtn"><input name="submit" type="submit" value="提 交"></div>
</form>
</div>
</div>
</div>
