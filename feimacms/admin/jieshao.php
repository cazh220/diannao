...
$query="select jieshao_ziduan from hyjieshao_table";
$result=mysql_query($query);

$row = mysql_fetch_array($result);

?> 
<form action="include/jieshao.php" method="post">
<div class="content">
<div class="contentTop">企业介绍</div>
<div class="jieshao">
<table width="700" align="center"><tr><td>
<textarea name="content" style="width:700px;height:500px;visibility:hidden;"><?php echo $row["jieshao_ziduan"]; ?></textarea>
</td></tr></table>
</div>
<div class="jieshaoBtn"><input name="submit" type="submit" value="提 交"></div>
</div>
</form>
<?php 
