...
<div class="content">
<div class="contentTop">管理新闻分类</div>
    <?php
...
<div class="fenleiListRight"><span><a href="upnewsfenlei.php?id=<?php echo $id ;?>">修改</a></span><span><a href="include/delnewsfenlei.php?id=<?php echo $id ;?>">删除</a></span></div>
</div>
       <?php
             }
       ?>
