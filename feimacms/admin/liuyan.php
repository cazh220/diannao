...
$query="select * from hyliuyan_table where id=$id";
...
?>
<div class="content">
<div class="contentTop">留言查看</div>
<div class="liuyan">
<div class="liuyanLeft">留言姓名：</div><div class="liuyanRight"><?php  echo $row["name_ziduan"];?></div>
</div>
<div class="liuyan">
<div class="liuyanLeft">联系电话：</div><div class="liuyanRight"><?php  echo $row["tel_ziduan"];?></div>
</div>
<div class="liuyan">
<div class="liuyanLeft">QQ：</div><div class="liuyanRight"><?php  echo $row["qq_ziduan"];?></div>
</div>
<div class="liuyan">
<div class="liuyanLeft">Email：</div><div class="liuyanRight"><?php  echo $row["email_ziduan"];?></div>
</div>
<div class="liuyan">
<div class="liuyanLeft">留言标题：</div><div class="liuyanRight"><?php  echo $row["title_ziduan"];?></div>
</div>
<div class="liuyanNeirong">
<div class="liuyanNeirongLeft">留言内容：</div>
<div class="liuyanNeirongRight"><?php  echo $row["content_ziduan"];?></div>
</div>
</div>
