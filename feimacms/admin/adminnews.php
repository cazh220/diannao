...
<div class="content">
<div class="contentTop">管理新闻</div>
<?php 
include("../include/conn.php");
$Page_size=10; 
$result=mysql_query("select * from hynews_table"); 
...
$sql="select * from hynews_table limit $offset,$Page_size"; 
$result=mysql_query($sql); 
while ($row=mysql_fetch_array($result)) { 
?>
<div class="newsList">
<div class="newsListLeft"><?php echo $row['title_ziduan']?></div>
<div class="newsListRight"><span><a href="upnews.php?id=<?php echo $row['id']?>">修改</a></span><span><a href="include/delnews.php?id=<?php echo $row['id']?>">删除</a></span></div>
</div>
<?php 
} 
...
$key.='</div>'; 
?> 
<div class="newsListFenye"><?php echo $key?></div>
</div>
</div>
</div>
