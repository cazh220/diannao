...
?>
  <form action="include/seo.php" method="post">
<div class="content">
<div class="contentTop">网站SEO设置</div>
<div class="seo">
<div class="seoLeft">网站标题：</div><div class="seoRight"><input name="title" size="65" value="<?php echo $row["title_ziduan"]; ?>"></div>
</div>
<div class="seo">
<div class="seoLeft">关键词：</div><div class="seoRight"><textarea name="keywords" cols="64" rows="10"><?php echo $row["keywords_ziduan"]; ?></textarea></div>
</div>
<div class="seo">
<div class="seoLeft">网站描述：</div><div class="seoRight"><textarea name="description" cols="64" rows="10"><?php echo $row["description_ziduan"]; ?></textarea></div>
</div>
<div class="seoBtn"><input name="submit" type="submit" value="提 交"></div>
</div>
  </form>
<?php 
