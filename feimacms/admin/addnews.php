...
if($_POST)
{
	...
	$newsFenlei = !empty($_POST['newsFenlei']) ? trim($_POST['newsFenlei']) : '';
	
	$sql = "INSERT INTO hynews_table(title_ziduan, content_ziduan, date_ziduan, fenlei_ziduan)VALUES('".$title."','".$content."',NOW(),'".$newsFenlei."')";
	//echo $sql;die;
...
<div class="content">
<div class="contentTop">添加新闻</div>
<div class="news">
<div class="newsLeft">新闻标题：</div><div class="newsRight"><input name="title" size="60"></div>
</div>
<div class="news">
...
<div class="news">
<div class="newsLeft">新闻内容：</div>
<div class="newsRight">
<textarea name="content" style="width:80%;height:450px;visibility:hidden;"></textarea>
</div>
</div>
