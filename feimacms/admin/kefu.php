...
?>
<form action="include/kefu.php" method="post">
<div class="content">
<div class="contentTop">在线客服设置</div>
<div class="kefu">
<div class="kefuLeft">客服QQ：</div><div class="kefuRight"><input name="qq" size="40" value="<?php echo $row["kefu_ziduan"]; ?>">
</div>
</div>

<div class="kefuBtn"><input name="submit" type="submit" value="提 交"></div>
</div>
</form>
<?php 
