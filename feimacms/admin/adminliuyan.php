...
<div class="content">
<div class="contentTop">留言管理</div>
<?php 
include("../include/conn.php");
$Page_size=10; 
$result=mysql_query("select * from hyliuyan_table"); 
...
$sql="select * from hyliuyan_table limit $offset,$Page_size"; 
$result=mysql_query($sql); 
while ($row=mysql_fetch_array($result)) { 
?>
<div class="liuyanList">
<div class="liuyanListLeft"><a href="liuyan.php"><?php echo $row['name_ziduan']?></a></div>
<div class="liuyanListRight"><span><a href="liuyan.php?id=<?php echo $row['id']?>">查看</a></span><span><a href="include/delliuyan.php?id=<?php echo $row['id']?>">删除</a></span></div>
</div>
<?php 
} 
...
$key.='</div>'; 
?> 
<div class="liuyanListFenye"><?php echo $key?></div>
</div>
</div>
</div>
